...
public class Database {
    ...
    public Database(){
        ...
        MedicalFile medicalFile1 = new MedicalFile("diagnostic1",recommendations,"2018-03-24",1421,"2018-04-17", "2018-05-19");
        MedicalFile medicalFile2 = new MedicalFile("diagnostic1",recommendations,"2018-03-24",1421, "2018-04-17", "2018-05-19");
        MedicalFile medicalFile3 = new MedicalFile("diagnostic1",recommendations,"2018-03-24",2821, "2018-04-17", "2018-05-19");


        patients.add(new Patient(1542,"2961231190438","Dora","Dumitrascu",21,"address1",medicalFile1));
        patients.add(new Patient(2321,"1960512789456","Florin","Bologheanu",21,"address2",medicalFile2));
        patients.add(new Patient(5432,"2961130178654","Silvana","Man",21,"address3",medicalFile3));

        physicians.add(new Physician(1421,"Doctor","1","Oncologist","sign1"));
        physicians.add(new Physician(2821,"Doctor","2","Oncologist","sign2"));
    }
